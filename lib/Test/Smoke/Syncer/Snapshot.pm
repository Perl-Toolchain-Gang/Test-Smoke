...
sub __vms_untargz {
    ...
    local *TMPCOM;
    open TMPCOM, "> TS-UNTGZ.COM" or do {
        require Carp;
        Carp::croak("Can't open 'TS-UNTGZ.COM' for writing: $!");
    };
    print TMPCOM <<EO_UNTGZ;
...
EO_UNTGZ
    close TMPCOM or do {
        require Carp;
        Carp::croak("Can't close 'TS-UNTGZ.COM': $!");
    };
